...
- (void) doCheckIn{
    ...
    NSString  *jsonRes = [NSString stringWithContentsOfURL:url encoding:NSUTF8StringEncoding error:nil];// me keyur
...
- (void)bannerViewDidLoadAd:(ADBannerView *)banner
{
    if (!self.bannerIsVisible)
    {
        ...
        scrollPlace.frame=CGRectMake(0, 50, 320,367);
        scrollPlace.contentSize=CGSizeMake(320, 370);
...
- (void)bannerView:(ADBannerView *)banner didFailToReceiveAdWithError:(NSError *)error
{
    if (self.bannerIsVisible)
    {
        ...
        scrollPlace.frame=CGRectMake(0, 0, 320,367);
        scrollPlace.contentSize=CGSizeMake(320, 370);
